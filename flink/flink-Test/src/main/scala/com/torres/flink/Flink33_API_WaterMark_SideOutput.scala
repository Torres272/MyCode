...
object Flink33_API_WaterMark_SideOutput {
    def main(args: Array[String]): Unit = {
        ...
        //apply方法
        val applyDS: DataStream[String] =
            windowDS.allowedLateness(Time.seconds(2))
              .sideOutputLateData(outputTag)
              .apply((key: String, window: TimeWindow, datas: Iterable[WaterSensor], out: Collector[String]) => {
        ...
        val lateData: DataStream[WaterSensor] = applyDS.getSideOutput(outputTag)
        lateData.print("late>>>>")
