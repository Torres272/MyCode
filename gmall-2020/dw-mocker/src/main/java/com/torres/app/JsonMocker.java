...
import com.torres.uploader.LogUploader;
import com.torres.util.RanOpt;
import com.torres.util.RandomDate;
import com.torres.util.RandomNum;
import com.torres.util.RandomOptionGroup;
...
public class JsonMocker {
    ...
    private String appId = "gmall190826";
    ...
    private RanOpt[] eventOpts = {new RanOpt("addFavor", 1), new RanOpt("addComment", 3), new RanOpt("addCart", 2), new RanOpt("clickItem", 4), new RanOpt("coupon", 95)};
    ...
    private String initStartsupLog() {
        ...
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("logtype", "startup");
        jsonObject.put("mid", mid);
        jsonObject.put("uid", uid);
        jsonObject.put("os", os);
        jsonObject.put("appid", appid);
